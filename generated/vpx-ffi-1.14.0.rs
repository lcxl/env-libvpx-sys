...
pub const VPX_TPL_ABI_VERSION: u32 = 2;
pub const VPX_EXT_RATECTRL_ABI_VERSION: u32 = 7;
...
pub const VPX_ENCODER_ABI_VERSION: u32 = 34;
...
extern "C" {
    pub fn vpx_write_tpl_gop_stats(
        tpl_file: *mut FILE,
        tpl_gop_stats: *const VpxTplGopStats,
    ) -> vpx_codec_err_t;
}
extern "C" {
    pub fn vpx_read_tpl_gop_stats(
        tpl_file: *mut FILE,
        tpl_gop_stats: *mut VpxTplGopStats,
    ) -> vpx_codec_err_t;
}
extern "C" {
    pub fn vpx_free_tpl_gop_stats(tpl_gop_stats: *mut VpxTplGopStats);
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
